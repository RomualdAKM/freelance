...
const getDossiers = () => {
    axios.get('/api/get_all_documents', { params: { search: search.value } }).then((response) => {
        ...
        <div  class="content">
            ...
            <div class="grid grid-cols-12 gap-6 mt-5">
                       <div class="intro-y col-span-12 flex justify-between flex-wrap sm:flex-no-wrap items-center mt-2">
                           <router-link to="/add-dossier" class="button text-white bg-theme-1 shadow-md mr-2">Nouveau Dossier</router-link>
